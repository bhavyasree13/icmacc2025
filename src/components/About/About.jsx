...
const Card = ({ children, bg = "white", animationType = "slideUp", delay = 0 }) => {
  const ref = useRef(null);
  const [visible, setVisible] = useState(false);
  ...
  const getAnimationClasses = () => {
    ...
    switch (animationType) {
      case "slideLeft":
        return `${baseClasses} ${visible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-16"}`;
      case "slideRight":
        return `${baseClasses} ${visible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-16"}`;
      case "fadeScale":
        return `${baseClasses} ${visible ? "opacity-100 scale-100" : "opacity-0 scale-90"}`;
      case "rotate":
        return `${baseClasses} ${visible ? "opacity-100 rotate-0" : "opacity-0 rotate-3"}`;
      default: // slideUp
        return `${baseClasses} ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`;
    }
  };
  ...
  return (
    <section
      ...
      className={`mx-4 md:mx-16 my-8 p-6 md:p-12 rounded-2xl border border-gray-200/50 shadow-lg backdrop-blur-sm
        ...
        ${bg === "gray" ? "bg-gradient-to-br from-gray-50/90 to-gray-100/90" : "bg-gradient-to-br from-white/90 to-gray-50/90"}
        ...
        <Card animationType="fadeScale" delay={200}>
          ...
          <AnimatedText delay={400}>
            <p className="text-base md:text-lg leading-relaxed text-gray-700 text-justify">
              The 2nd International Conference on recent trends in Microelectronics, Automation, Computing and Communications Systems (ICMACC-24) is focused on research and emphasizes on the latest technological advancements. The conference aims to provide outstanding opportunities for both academic and industrial communities to address new trends and challenges and emerging technologies on the topics relevant to today's fast-moving areas in the fields of Microelectronics, Automation, Computing and Communications Systems, and so on.
            </p>
          </AnimatedText>
          <AnimatedText delay={600}>
            <p className="text-base md:text-lg leading-relaxed text-gray-700 mt-4 text-justify">
              The conference comprises keynote addresses, invited talks, refereed paper and poster presentations, pre-conference tutorials, product exhibition, and panel discussion. The vision of the ICMACC-24 is to promote brainstorming and collaboration so that critical issues pertaining to individual research activities can be addressed and ideas can be exchanged through extensive discussions. The conference focuses on specific engineering streams, allowing the speakers to dwell deep into the very next day. The conference is technically co-sponsored by IEEE Hyderabad Section and is approved by IEEE with conference ID: #62921.
            </p>
          </AnimatedText>
        </Card>
        ...
        <Card animationType="slideRight" delay={400}>
          ...
          <AnimatedText delay={300}>
            <div className="bg-gradient-to-r from-orange-50/50 to-pink-50/50 p-6 rounded-xl border border-orange-200/30">
              <p className="text-base md:text-lg leading-relaxed text-gray-700 text-justify">
                The IEEE Hyderabad Section is one of the most active sections of IEEE in India. IEEE was formally introduced in Hyderabad, in June 1981, when a group of engineers in Hyderabad decided to form an IEEE sub-section. This sub-section was rapidly elevated to a full section, in 1984 (the year of IEEE Centenary celebrations). All IEEE members residing in the Indian states of Telangana and Andhra Pradesh (excluding geography of Vizag Bay section) are members of the IEEE Hyderabad Section.
                <a href="https://ieeehyderabad.org" className="inline-block ml-2 px-3 py-1 bg-gradient-to-r from-orange-500 to-pink-500 text-white text-sm rounded-full hover:from-orange-600 hover:to-pink-600 transition-all duration-300 hover:scale-105 hover:shadow-md" target="_blank" rel="noopener noreferrer">
                  More Info →
                </a>
              </p>
            </div>
        ...
        <Card bg="gray" animationType="rotate" delay={500}>
          ...
          <AnimatedText delay={400}>
            <div className="bg-gradient-to-r from-indigo-50/50 to-purple-50/50 p-6 rounded-xl border border-indigo-200/30">
              ...
              <p className="text-base md:text-lg leading-relaxed text-gray-700 mt-4 text-justify">
                This process, along with a conscientious will to put Success and Happiness first leading to a better future has put VNRVJIET at the forefront of academic excellence. The Institute is approved by AICTE and is affiliated to JNTU-H. It offers 14 UG programmes, 14 PG programmes, and Ph.D. programmes under NDF scheme of AICTE—the only Institute in the Telangana State to get this recognition!—thus imparting quality education to over 6000 students every year.
                <a href="https://www.vnr.ac.in" className="inline-block ml-2 px-3 py-1 bg-gradient-to-r from-indigo-500 to-purple-500 text-white text-sm rounded-full hover:from-indigo-600 hover:to-purple-600 transition-all duration-300 hover:scale-105 hover:shadow-md" target="_blank" rel="noopener noreferrer">
                  More Info →
                </a>
              </p>
            </div>
